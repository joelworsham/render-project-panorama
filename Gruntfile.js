...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            ...
            src: {
                files: {
                    'src/assets/js/render-psp.min.js': ['src/assets/js/source/**/*.js', '!src/assets/js/source/admin/**/*.js']
                }
            },
            admin: {
                files: {
                    'src/assets/js/render-psp-admin.min.js': ['src/assets/js/source/admin/*.js']
                }
            }
        },
        ...
        sass: {
            ...
            src: {
                files: {
                    'src/assets/css/render-psp.min.css': 'src/assets/scss/main.scss'
                }
            },
            admin: {
                files: {
                    'src/assets/css/render-psp-admin.min.css': 'src/assets/scss/admin/admin.scss'
                }
            }
        },
        ...
        'string-replace': {
            version: {
                ...
                options: {
                    replacements: [{
                        ...
                        pattern: /(define.*?RENDER_PSP_VERSION.*?)\d\.\d\.\d/,
                        replacement: "$1" + pkg.version
                    }]
                }
            },
            header: {
                files: {
                    'build/render-psp.php': ['build/render-psp.php', '!' + image_ignore]
                },
                options: {
                    replacements: [{
                        pattern: /\/\/\{\{HEADER}}/,
